 ...
 */
@Configuration
@EnableJpaRepositories(basePackages="com.itheima.spring实战.spittr.dao", entityManagerFactoryRef = "emf") // 扫描扩展自SpringData JPA Repository接口的所有接口
public class SpittrConfig {
  ...
  public LocalContainerEntityManagerFactoryBean emf(DataSource dataSource, JpaVendorAdapter jpaVendorAdapter) {
    ...
    emf.setPackagesToScan("com.itheima.spring实战.spittr.domain");
    return emf;
  }
