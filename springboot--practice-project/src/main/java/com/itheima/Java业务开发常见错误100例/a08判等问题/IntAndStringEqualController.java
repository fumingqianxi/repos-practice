...
@Slf4j
@RestController
@RequestMapping("/int-and-string-equal")
public class IntAndStringEqualController {

  List<String> list = new ArrayList<>();

  /**
   * http://localhost:45678/int-and-string-equal/internperformance.
   *
   * @param size .
   * @return .
   */
  ...
  /** http://localhost:45678/int-and-string-equal/stringcompare. */
  ...
  /** http://localhost:45678/int-and-string-equal/intcompare. */
  ...
  /**
   * http://localhost:45678/int-and-string-equal/enumcompare.
   *
   * @param orderQuery .
   */
