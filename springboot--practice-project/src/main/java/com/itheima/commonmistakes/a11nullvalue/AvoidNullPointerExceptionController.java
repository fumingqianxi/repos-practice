...
@Slf4j
@RestController
@RequestMapping("/avoid-null-pointer-exception")
public class AvoidNullPointerExceptionController {

  /**
   * http://localhost:45678/avoid-null-pointer-exception/wrong.
   *
   * @param test .
   * @return .
   */
  ...
  /**
   * http://localhost:45678/avoid-null-pointer-exception/right.
   *
   * @param test .
   * @return .
   */
