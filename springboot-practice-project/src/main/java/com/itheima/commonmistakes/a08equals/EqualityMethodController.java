...
@RestController
@Slf4j
@RequestMapping("/equality-method")
public class EqualityMethodController {

  /**
   * http://localhost:45678/equality-method/wrong.
   */
  @GetMapping("wrong")
  public void wrong() {
  ...
  /**
   * http://localhost:45678/equality-method/wrong2.
   */
  @GetMapping("wrong2")
  public void wrong2() {
  ...
  /**
   * http://localhost:45678/equality-method/right.
   */
  @GetMapping("right")
  public void right() {
